...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function startGame() {
    if (gameView.game && gameView.game.isStarted && !gameView.game.isGameOver) {
  ...
  // Function to check inputs and start game if necessary
  function checkInputsAndStartGame() {
    // if (gameView.startButtonPressed && (!gameView.game || !gameView.game.isStarted || gameView.game.isGameOver)) {
    if (gameView.startButtonPressed) {
      startGame();
    }
    requestAnimationFrame(checkInputsAndStartGame);
  }

  // Start checking for inputs
  checkInputsAndStartGame();
